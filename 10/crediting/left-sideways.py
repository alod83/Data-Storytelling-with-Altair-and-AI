...
df['url'] = ''
df.loc[df['Training Type'] == 'Cycling', 'url'] = 'images/cycling.png'
df.loc[df['Training Type'] == 'Rowing', 'url'] = 'images/rowing.png'
...
# Add the following text to the chart:
# "Images: source DALL-E, Title: source ChatGPT"
...
# Save the chart as 'left-sideways.html'


chart.save('left-sideways.html')
